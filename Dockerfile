...
COPY --from=builder /hana/target/production/hana /usr/local/bin/hana-rpc
COPY --from=builder /hana/target/production/hana /usr/local/bin/hana-sentry
COPY --from=builder /hana/target/production/hana /usr/local/bin/hana-toolbox
COPY --from=builder /hana/target/production/hana /usr/local/bin/consensus-tests
