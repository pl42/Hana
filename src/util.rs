                ...
                .with(
                    console_subscriber::ConsoleLayer::builder()
                        ...
                        .with_filter(EnvFilter::new(
                            "tokio=trace,runtime=trace,hana=trace,hana::sentry=info",
                        )),
                )
        }
